...
class PostTextScreenCopyDemo extends StatefulWidget {
  final String email;
  const PostTextScreenCopyDemo({super.key, required this.email});

  @override
  State<PostTextScreenCopyDemo> createState() => _PostTextScreenCopyDemoState();
}

class _PostTextScreenCopyDemoState extends State<PostTextScreenCopyDemo> {

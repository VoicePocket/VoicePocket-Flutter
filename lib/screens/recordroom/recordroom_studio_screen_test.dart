...
class RecordroomStudioTestScreen extends StatefulWidget {
  final Map<String, List<String>> metaData;
  final int modelIndex;
  const RecordroomStudioTestScreen(
      {super.key, required this.metaData, required this.modelIndex});

  @override
  State<RecordroomStudioTestScreen> createState() =>
      _RecordroomStudioTestScreenState();
}

class _RecordroomStudioTestScreenState
    extends State<RecordroomStudioTestScreen> {
  ...
  void initState() {
    super.initState();
    requestPermission();
    _maxLine = widget.metaData['name']!.length;
    getPublicDownloadFolderPath().then((dir) {
      modelDir = Directory("${dir.path}/model/test");
  ...
  loadList() async {
    final list = await loadRandomCSV();
    name = list['name']!;
